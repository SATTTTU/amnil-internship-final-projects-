...
* Check the `ConnectionStrings` in `appsettings.json` files under the `Acme.Ecommerce.Web` and `Acme.Ecommerce.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 62a1473b-bf27-4647-9ff2-2b5d08a0b9a8
```

> `62a1473b-bf27-4647-9ff2-2b5d08a0b9a8` is the password of the certificate, you can change it to any password you want.
...
* `Acme.Ecommerce.Web`: ASP.NET Core MVC / Razor Pages application that is the essential web application of the solution.
